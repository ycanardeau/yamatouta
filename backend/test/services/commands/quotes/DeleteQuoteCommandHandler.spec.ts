...
import { DeleteQuoteCommandHandler } from '../../../../src/services/commands/entries/DeleteEntryCommandHandler';
...
describe('DeleteQuoteCommandHandler', () => {
	...
	describe('deleteQuote', () => {
		const testDeleteQuote = async (): Promise<void> => {
			await deleteQuoteCommandHandler.execute(quote.id);
		...
		test('insufficient permission', async () => {
			...
			for (const userGroup of userGroups) {
				...
				await expect(
					deleteQuoteCommandHandler.execute(quote.id),
